...
{
    public class RegionalWeatherViewModel : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegionalWeatherViewModel"/> class.
        /// </summary>
        public RegionalWeatherViewModel()
        {
            _location = null;
            _conditions = null;
